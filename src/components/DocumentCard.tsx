...
export default function DocumentCard({
  ...
  return (
    <TouchableOpacity onPress={onOpen} className="bg-white/10 rounded-xl p-3">
      ...
      <TouchableOpacity onPress={onDelete} className="self-end mt-2 px-2 py-1 rounded bg-red-500/30">
